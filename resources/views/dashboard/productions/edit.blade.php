<x-layouts.dashboard title="Edit Production" heading="Edit Production">
    <div class="panel">
                ...
                <div class="grid-2">
                    ...
                    <div class="field">
                        ...
                        <select name="production_type" id="production-type">
                            <option value="biasa" @selected(old('production_type', $production->production_type) === 'biasa')>Biasa</option>
                            <option value="pengobatan" @selected(old('production_type', $production->production_type) === 'pengobatan')>Pengobatan</option>
                        </select>
                    </div>
                    ...
                    <div class="field" style="grid-column: 1 / -1;">
                        ...
                        <select name="concept_id" id="concept-select">
                            @php($c = (int) old('concept_id', $production->concept_id))
                    ...
                    <div class="field">
                        ...
                        <div class="inline">
                            <input class="w-220" type="number" step="0.0001" name="target_weight_value" value="{{ old('target_weight_value', $production->target_weight_kg) }}">
                    ...
                    <div class="field">
                        ...
                        <div class="inline">
                            <input class="w-220" type="number" name="duration_days" value="{{ old('duration_days', $production->duration_days) }}" min="1" placeholder="20" id="duration-days">
