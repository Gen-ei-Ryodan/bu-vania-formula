        ...
        <form method="POST" action="{{ route('treatments.update', $production) }}">
            ...
            <div class="form-card">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="field">
                            ...
                            <div class="input-group" style="max-width: 380px;">
                                <input type="number" step="0.0001" name="target_weight_value" value="{{ old('target_weight_value', $production->target_weight_kg) }}" id="target-weight-value">
                        ...
                        <div class="field">
                            ...
                            <div class="field-inline">
                                <input type="number" name="duration_days" value="{{ old('duration_days', $production->duration_days) }}" min="1" id="duration-days" style="width: 140px;">
                ...
                <div class="form-card-footer">
                    <a class="btn btn-ghost" href="{{ route('treatments.show', $production) }}">Batal</a>
                    <button class="btn btn-primary btn-lg" type="submit">Update Pengobatan</button>
                </div>
            </div>
        </form>
    </div>
