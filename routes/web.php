...
use App\Http\Controllers\Dashboard\LaporanSoreController;
use App\Http\Controllers\Dashboard\LocationController;
use App\Http\Controllers\Dashboard\PembuatController;
...
Route::middleware('auth')->group(function () {
    ...
    // Laporan Sore - accessible by all roles
    Route::resource('/laporan-sore', LaporanSoreController::class)->except(['edit', 'update']);

    // Admin-only routes
    Route::middleware('role:admin')->group(function () {
        Route::resource('/units', UnitController::class)->except(['show']);
        Route::resource('/categories', CategoryController::class)->only(['index', 'store', 'update', 'destroy']);
        Route::resource('/pembuats', PembuatController::class)->except(['show']);
